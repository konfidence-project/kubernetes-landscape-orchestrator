[![REUSE status](https://api.reuse.software/badge/github.com/konfidence-project/landscape-kubernetes-task-execution-controller)](https://api.reuse.software/info/github.com/konfidence-project/landscape-kubernetes-task-execution-controller)

# landscape-kubernetes-task-execution-controller

## About this project

The Kubernetes Task Execution Controller creates a job in the target Kubernetes cluster and monitors its execution.
