...
func (r *ReadyConditionStatusUpdater) MutateStatus(_ context.Context, deployment *landscapev1alpha1.ArtifactDeployment) error {
	if meta.IsStatusConditionTrue(deployment.Status.Conditions, landscapev1alpha1.AppHealthyCondition) &&
		meta.IsStatusConditionTrue(deployment.Status.Conditions, landscapev1alpha1.DeploymentResultCreatedCondition) {
